...
public class GiaoDienThemNhanSu extends JFrame implements ActionListener, MouseListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		//			if(cmbChucVu.getSelectedItem().toString()=="Không có") {
		//				cmbLoaiNS.setModel(new DefaultComboBoxModel(new String[] {"Chọn"}));
		//				cmbVaiTro.setModel(new DefaultComboBoxModel(new String[] {"Chọn"}));
		//				cmbLoaiNS.addItem("Công nhân");
		//				cmbLoaiNS.addItem("Nhân viên");
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GiaoDienThemNhanSu window = new GiaoDienThemNhanSu();
