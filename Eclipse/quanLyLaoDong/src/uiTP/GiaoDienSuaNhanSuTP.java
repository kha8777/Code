...
public class GiaoDienSuaNhanSuTP extends JFrame implements ActionListener, MouseListener {
...
//		lblDiaChiLH.setFont(new Font("Tahoma", Font.PLAIN, 15));
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {			
				try {
					GiaoDienSuaNhanSuTP window = new GiaoDienSuaNhanSuTP();
