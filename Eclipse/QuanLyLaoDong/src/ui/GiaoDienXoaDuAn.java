...
public class GiaoDienXoaDuAn extends JFrame implements ActionListener, MouseListener {
	...
	private JButton btnLuu,btnXoaCongViec, btnThoat, btnXoaTrong;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GiaoDienXoaDuAn frame = new GiaoDienXoaDuAn();
	...
	public GiaoDienXoaDuAn() {
		...
		JLabel lblTitleXoaDuAn = new JLabel("XÓA DỰ ÁN");
		lblTitleXoaDuAn.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitleXoaDuAn.setFont(new Font("Tahoma", Font.PLAIN, 24));
		...
		txtNoiThiCong.setEditable(false);
		...
		btnXoaCongViec = new JButton("XÓA CÔNG VIỆC");
		btnXoaCongViec.setFont(new Font("Tahoma", Font.PLAIN, 18));
		...
		gl_Khung.setHorizontalGroup(
			gl_Khung.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Khung.createSequentialGroup()
					.addGap(462)
					.addComponent(lblTitleXoaDuAn, GroupLayout.PREFERRED_SIZE, 261, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_Khung.createSequentialGroup()
					.addGap(10)
				...
				.addGroup(gl_Khung.createSequentialGroup()
					.addGap(50)
					.addComponent(btnXoaCongViec, GroupLayout.PREFERRED_SIZE, 182, GroupLayout.PREFERRED_SIZE)
					.addGap(129)
		...
		gl_Khung.setVerticalGroup(
			gl_Khung.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Khung.createSequentialGroup()
					.addComponent(lblTitleXoaDuAn, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(1)
							.addComponent(btnXoaCongViec, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(1)
		...
		btnXoaCongViec.addActionListener(this);
		updatetk1();
		updatetk2();
		updatetk3();
		updatetk4();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnLuu)) {
			...
			int row = table.getSelectedRow();
			int hoiNhac = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa dự án? ","Chú ý",JOptionPane.YES_NO_OPTION);
			if(hoiNhac==JOptionPane.YES_OPTION ) {
				while(row != -1) {
					int maDuAn1 = table.convertRowIndexToModel(row);
					String maDuAn = (String)table.getValueAt(row,0);
					tableModel.removeRow(maDuAn1);
					row = table.getSelectedRow();
					qltda.XoaDuAn(maDuAn); 
		...
		if(o.equals(btnXoaCongViec)) {

			java.awt.EventQueue.invokeLater(new Runnable() {
				public void run() {
					GiaoDienXoaCongViec main = new GiaoDienXoaCongViec();
					main.setVisible(true);
					main.setLocationRelativeTo(null);
				}
			});
