...
public class GiaoDienChinh extends JFrame implements ActionListener {
	...
	public GiaoDienChinh() {
		...
		item3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F3,ActionEvent.ALT_MASK));
		menu1.add(item1);
		menu1.add(item2);
		menu1.add(item3);
		...
		item4.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F4,ActionEvent.ALT_MASK));
		item5.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F5,ActionEvent.ALT_MASK));
		item6.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F6,ActionEvent.ALT_MASK));
		menu2.add(item4);
		menu2.add(item5);
		menu2.add(item6);
		//	menu2.add(item7);
		...
		menu3.add(item8);
		item8.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F7,ActionEvent.ALT_MASK));
		...
		item9.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F8,ActionEvent.ALT_MASK));
		item10.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F9,ActionEvent.ALT_MASK));
		menu4.add(item9);
		menu4.add(item10);
		...
		item11.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F10,ActionEvent.ALT_MASK));
		menu5.add(item11);
		...
		item7.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F11,ActionEvent.ALT_MASK));
		item14.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F12,ActionEvent.ALT_MASK));
		//menu6.add(item12);
		menu6.add(item7);
		menu6.add(item14);
		...
		JLabel lblNewLabel_5 = new JLabel("Welcome  to HƯNG THỊNH ICONS");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 50));
		lblNewLabel_5.setForeground(new Color(0, 153, 255));
		lblNewLabel_5.setBounds(150, 209, 900, 112);
		panel_3.add(lblNewLabel_5);

//		btnNewButton = new JButton();
//		btnNewButton.setIcon(new ImageIcon("Image/exit.png"));
//		btnNewButton.setBounds(1067, 502, 51, 30);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(44)
							.addComponent(panel, GroupLayout.PREFERRED_SIZE, 1084, GroupLayout.PREFERRED_SIZE))
