...
public class GiaoDienSuaDuAn extends JFrame implements ActionListener, MouseListener {
	...
	private JButton btnLuu, btnThoat, btnXoaTrong, btnThemCongViec;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GiaoDienSuaDuAn frame = new GiaoDienSuaDuAn();
	 ...
	 */
	public GiaoDienSuaDuAn() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1377, 700);
		...
		lblNewLabel.setBounds(32, 11, 1078, 59);
		...
		JLabel lblTitleSuaDuAn = new JLabel("SỬA DỰ ÁN");
		lblTitleSuaDuAn.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitleSuaDuAn.setFont(new Font("Tahoma", Font.PLAIN, 24));
		...
		cmbTrangThaiDuAn.addItem("Hoan thanh");
		...
		btnThemCongViec = new JButton("SỬA CÔNG VIỆC");
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
							.addComponent(panel, GroupLayout.DEFAULT_SIZE, 1074, Short.MAX_VALUE)
							.addGap(59))
		...
		gl_Khung.setHorizontalGroup(
			gl_Khung.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Khung.createSequentialGroup()
					.addGap(462)
					.addComponent(lblTitleSuaDuAn, GroupLayout.PREFERRED_SIZE, 261, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_Khung.createSequentialGroup()
					.addGap(10)
					...
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(88)
							.addComponent(txtChuDauTu, GroupLayout.PREFERRED_SIZE, 121, GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(gl_Khung.createSequentialGroup()
					...
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(79)
							.addComponent(textTenDuAn, GroupLayout.PREFERRED_SIZE, 121, GroupLayout.PREFERRED_SIZE))
						.addComponent(lblTenDuAn, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE))
					.addGap(46)
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(89)
							.addComponent(txtNoiThiCong, GroupLayout.PREFERRED_SIZE, 121, GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(gl_Khung.createSequentialGroup()
					.addContainerGap()
					.addComponent(pnTable, GroupLayout.DEFAULT_SIZE, 1125, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_Khung.setVerticalGroup(
			gl_Khung.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Khung.createSequentialGroup()
					.addComponent(lblTitleSuaDuAn, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(7)
							.addComponent(textTenDuAn, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE))
						...
						.addGroup(gl_Khung.createSequentialGroup()
							.addGap(7)
							.addComponent(txtGhiChu, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)))
					.addGap(11)
					.addGroup(gl_Khung.createParallelGroup(Alignment.LEADING)
	...
	private void suaDuAn() {
		...
		if(qltda.capNhat(textTenDuAn.getText(), txtChuDauTu.getText(),cmbTrangThaiDuAn.getSelectedItem().toString() , 
				df.format(dateNgayCapPhep.getDate()).toString(),df.format(dateNgayKhoiCong.getDate()).toString() ,df.format(dateNgayHoanThanhDuKien.getDate()).toString(),
				txtNoiThiCong.getText(),txtSoLuongNhanSuTrongDuAn.getText(), txtGhiChu.getText(), textMaDuAn.getText()))
		{

			table.setValueAt(textTenDuAn.getText(), row, 1);
			table.setValueAt(txtChuDauTu.getText(), row, 2);
			...
			table.setValueAt(txtNoiThiCong.getText(), row, 7);
			table.setValueAt(txtSoLuongNhanSuTrongDuAn.getText(), row, 8);
			table.setValueAt(txtGhiChu.getText(), row, 9);
			...
			JOptionPane.showMessageDialog(this, "Dự án sửa không được");
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnLuu)) {
			int hoiNhac = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn sửa dự án ? ","Chú ý",JOptionPane.YES_NO_OPTION);
		...
		if(o.equals(btnThoat)) {
			...
			int hoiNhac = JOptionPane.showConfirmDialog(this,"Thoát khỏi sửa dự án","Chú ý",JOptionPane.YES_NO_OPTION);
			if(hoiNhac==JOptionPane.YES_OPTION ) {
		...
		if(o.equals(btnThemCongViec)) {
			java.awt.EventQueue.invokeLater(new Runnable() {
				public void run() {
					GiaoDienSuaCongViec main = new GiaoDienSuaCongViec();
					main.setVisible(true);
					main.setLocationRelativeTo(null);
				}
			});
