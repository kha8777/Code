...
public class GiaoDienXoaNhanSuTP extends JFrame implements ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GiaoDienXoaNhanSuTP window = new GiaoDienXoaNhanSuTP();
